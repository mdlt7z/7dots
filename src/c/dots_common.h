...
#define PADDING PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 0, 9, 28, 0, 14, 0, 44)
#define DOT_RADIUS PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 0, 5, 5, 0, 8, 0, 8)
#define DOT_GAP PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 0, 9, 9, 0, 10, 0, 10)
#define DOT_COUNT 7
